...
public class Orc {
    ...
    public Orc(OrcDetails orcDetails) {
        this.setName(orcDetails.getName());
        this.setOrcRaceType(OrcRaceType.valueOf(orcDetails.getRaceType()));
        this.setKillCount(orcDetails.getKillCount() == null ? 0 : orcDetails.getKillCount());
        this.setWeapons(orcDetails.getWeapons().stream().map(WeaponType::valueOf).collect(Collectors.toList()));
    }
